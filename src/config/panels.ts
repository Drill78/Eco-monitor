...
import { DEFAULT_PANELS as ECO_PANELS, DEFAULT_MAP_LAYERS as ECO_MAP_LAYERS, MOBILE_DEFAULT_MAP_LAYERS as ECO_MOBILE_MAP_LAYERS } from './variants/eco';
